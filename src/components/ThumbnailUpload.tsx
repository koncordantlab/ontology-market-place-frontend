  ...
  const uploadFile = async (file: File) => {
    try {
      ...
      const result: SimpleUploadResult = await simpleUploadService.uploadThumbnail(file);
         ...
         // Apply thumbnail transformation for display
         const thumbnailUrl = result.url; // Use the URL directly for now
         setPreviewUrl(thumbnailUrl);
         onThumbnailUploaded(result.url); // Pass original URL to parent
